        ...
        <nav className="fixed top-0 w-full bg-fern">
            <div className="h-16 flex justify-between items-center">
                ...
                <div className="hidden sm:block space-x-4 px-3">
                    ...
                    <button class="btn relative inline-flex items-center justify-start overflow-hidden font-medium transition-all bg-wild-willow rounded-4xl hover:bg-wild-willow group py-1.5 px-6">
            ...
            {/* Menus Mobile */}
                <div className={`${isOpen? `hidden` : `block` } sm:hidden bg-merino space-x-2y-3 sm:block sm:flex`}>
                    ...
                    <a href="" className="text-gray-400 block font-medium p-2 hover:text-dell hover:bg-chalky">Login</a>
                    <a href=""className="text-gray-400 block font-medium p-2 hover:text-dell hover:bg-chalky">Register</a>
                </div>
        </nav>   
    )
}
